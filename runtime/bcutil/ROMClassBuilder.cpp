...
#define J9ROM_BUILDER_CLASS_VERSION_SHARE_ENABLED(classfile) (J9_IS_CLASSFILE_OR_ROMCLASS_PREVIEW_VERSION(classfile) ? J9ROM_BUILDER_SHARE_PREVIEW_CLASS : true)
...
ROMClassBuilder::prepareAndLaydown( BufferManager *bufferManager, ClassFileParser *classFileParser, ROMClassCreationContext *context )
{
	...
	if (context->isROMClassShareable() 
		&& J9ROM_BUILDER_CLASS_VERSION_SHARE_ENABLED(classFileParser->getParsedClassFile())
	) {
